...
import { ArrowBigLeft, Eye, EyeOff, Lock, LogIn, Mail } from "lucide-react";
...
function Login({ onLoginSuccess = null }) {
  ...
  //EMAIL VALIDAT FUNCTION
  const validate = () => {
    const e = {};
    if (!email) e.email = "Email is required";
    else if (!isValidEmail(email)) e.email = "please enter a valide email";
  ...
  return (
    <div className={loginStyles.pageContainer}>
      ...
      <Link to="/" className={loginStyles.backButton}>
        <ArrowBigLeft className={loginStyles.backButtonIcon} />
            ...
            <div className={loginStyles.animatedBorder}>
              <div className={loginStyles.formContent}>
                ...
                <p className={loginStyles.subtitle}>
                  Sign in to continue to hexagon Quiz. Light, clear UI - smooth
