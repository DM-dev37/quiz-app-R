...
const ResultSchema = new mongoose.Schema(
  {
    ...
    score: { type: Number, min: 0, max: 100, default: 0 }, //en pourcentage
...
ResultSchema.pre('save', function (next){
    ...
    if(this.score >= 85) this.performance = 'Exellent';
    else if(this.score >= 65) this.performace = 'Good';
    else if(this.score >= 45) this.performace = 'Average';
    else this.performace = 'Need work';
...
const Result = mongoose.models.Resul || mongoose.model('Result', ResultSchema);
